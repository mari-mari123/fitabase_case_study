...
# Load your CSV files
df_daily = pd.read_csv('data/daily_activity_data_analyze.csv')
...
plt.tight_layout()
plt.savefig("images/total_steps_by_weekday.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("images/average_steps_by_weekday.png", dpi=300)
plt.show()
...
plt.ticklabel_format(style='plain',axis='y')
plt.tight_layout()
plt.savefig("images/total_consuming_calories_by_weekday.png", dpi=300)
plt.show()
...
plt.ticklabel_format(style='plain',axis='y')
plt.tight_layout()
plt.savefig("images/average_consuming_calories_by_weekday.png", dpi=300)
plt.show()
...
plt.ylabel('Average Steps', size=15)
plt.savefig("images/average_steps_by_daytype.png", dpi=300)
plt.show()
...
plt.savefig("images/average_calories_by_daytype.png", dpi=300)
plt.show()
...
plt.ylabel('Average Consuming Calories', size=15)
plt.savefig("images/average_steps_by_month.png", dpi=300)
plt.show()
...
plt.xlabel('Month',size=15)
plt.ylabel('Average Consuming Calories', size=15)
plt.savefig("images/average_calories_by_month.png", dpi=300)
plt.show()
...
plt.xticks(rotation=60)
plt.tight_layout()
plt.savefig("images/distribution_of_total_steps.png", dpi=300)
plt.show()
...
plt.legend()
plt.savefig("images/distribution_of_calories.png", dpi=300)
plt.show()
...
plt.legend()
plt.savefig("images/active_users_vs_non-active_users_total_steps.png", dpi=300)
plt.show()
...
plt.ylabel('Very Active Minutes', size=15)
plt.legend()
plt.savefig("images/active_users_vs_non-active_users_calories.png", dpi=300)
plt.show()
